function y=clip_mx0p04_s15(x,vol)
%CLIP_MX0P04_S15 example clipping function for distortSim
%   y=CLIP_MX0P04_S15(x,vol) clips audio vector, x, based on volume vol.
