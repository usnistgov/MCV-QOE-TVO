...
% WRITETESTSTATE - writes a test info struct to a file
%
%   WRITETESTSTATE(fname,state) writes the test info stored in state to
%   the file with name fname. If fname exists then it is overwritten
%
